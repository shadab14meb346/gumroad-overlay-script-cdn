console.log("gumroad-overlya-assets.js file getting called");
...
const addClickEvent = (gumroadAnchorTag) => {
	...
	gumroadAnchorTag.addEventListener("click", (e) => {
		e.preventDefault();
		iFrame.src = gumroadAnchorTag.href;
